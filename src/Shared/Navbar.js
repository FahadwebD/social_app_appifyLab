...
<img className='object-cover h-10 w-40' src="https://i.ibb.co/h1HVXrf/logo.png" alt="" srcset="" />
  <div className="flex items-center bg-white rounded-3xl" >
      ...
      <input className="ml-3 py-2 outline-none bg-transparent w-96 " type="text" name="search" id="search" placeholder="Search..." />
    </div>
  <div className="flex items-center text-slate-500">
    
    <ul className="flex items-center space-x-6">
      <li className='text-white border-b-4  '>
      ...
      <li><svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg></li>
    </ul>
  ...
  <div class="flex items-center space-x-4">
    ...
    <div class="font-medium dark:text-white">
        ...
        <div class="flex text-sm text-gray-500 dark:text-gray-400">Adnan Chowdhury<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></div>
    </div>
</div>
</nav>
        </div>
